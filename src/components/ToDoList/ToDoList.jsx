...
const ToDoList = (props) => {
  ...
  useEffect(() => {
    setMenuOpen(!props.mobile)
  }, [props.mobile])

  return (
    <div style={{width: 270, backgroundColor: '#FFF'}} className={"z-50 left-0 ml-0 lg:ml-6 py-2 px-6 aspect-w-12 aspect-h-7 rounded-lg shadow-lg lg:aspect-none bg-white}"}>
