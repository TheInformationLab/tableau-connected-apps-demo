  ...
  return (
    <div className="bg-gray-100">
      <div className="relative overflow-hidden">
        <div className='max-w-7xl bg-white mx-auto px-4 mt-10 sm:px-6 rounded-t-lg'>
          <div className="relative pt-16 sm:pt-24 lg:pt-32">
              <div className="mx-auto max-w-md px-4 text-center sm:px-6 sm:max-w-3xl lg:px-8 lg:max-w-7xl">
                <div>
                  <h2 className="text-base font-semibold tracking-wider text-cyan-600 uppercase">Tableau Embed Demo</h2>
                  <p className="mt-2 text-3xl font-extrabold text-gray-900 tracking-tight sm:text-4xl">
                    Embed API v3 & Connected Apps
                  </p>
                </div>
              </div>
            </div>
        </div>
        <div className='bg-white pt-10 max-w-7xl mx-auto rounded-b-lg' >
          <TableauEmbed />
        </div>
